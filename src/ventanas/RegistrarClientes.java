...
public class RegistrarClientes extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton_registarCliente = new javax.swing.JButton();
        ...
        getContentPane().add(txt_correo, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 130, 210, -1));
        ...
        jButton_registarCliente.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/add.png"))); // NOI18N
        jButton_registarCliente.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton_registarClienteActionPerformed(evt);
            }
        });
        getContentPane().add(jButton_registarCliente, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 110, 120, 100));
    ...
    private void jButton_registarClienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_registarClienteActionPerformed

        int validacion = 0;
        String nombre, mail, telefono, direccion = "";

        mail = txt_correo.getText().trim();
    ...
    }//GEN-LAST:event_jButton_registarClienteActionPerformed
    ...
    private javax.swing.JButton jButton_registarCliente;
