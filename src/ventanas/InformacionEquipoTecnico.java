...
public class InformacionEquipoTecnico extends javax.swing.JFrame {
    ...
    public InformacionEquipoTecnico() {
        ...
        id_equipo_update = GestionarEquipos.id_equipo_update;
        ...
        try {
            ...
            PreparedStatement pst = cn.prepareStatement(
                "select * from equipos where id_equipo = '" + id_equipo_update + "'");
            ...
            if(rs.next()){
                ...
                txt_comentariosTecnicos.setText(rs.getString("comentarios_tecnicos"));
    ...
    private void initComponents() {
        ...
        getContentPane().add(lbl_wallpaper, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 641, 447));
    ...
    private void jButton_actualizarEquipoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_actualizarEquipoActionPerformed
        ...
        String  modelo, noSerie, coment_tecnico, tipoEquipo_string = "", Marca_string = "", estatus_string = "";
        ...
        coment_tecnico = txt_comentariosTecnicos.getText().trim();
        ...
        if(coment_tecnico.equals("")){
            txt_comentariosTecnicos.setBackground(Color.red);
            validacion++;
        }
        ...
        if (validacion == 0) {
            ...
            try{
                ...
                PreparedStatement pst = cn.prepareStatement("update equipos set tipo_equipo ='"+tipoEquipo_string+"',marca='"+Marca_string+"',modelo='"+txt_modelo.getText()+"',num_serie='"+txt_noSerie.getText()+"',"
                    +"estatus='"+estatus_string+"',ultima_modificacion='"+user+"',comentarios_tecnicos='"+txt_comentariosTecnicos.getText()+"'where id_equipo ='"+id_equipo_update+"'");
